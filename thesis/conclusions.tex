...
The present dataset allows one to explore also the relation of the black hole mass with 
the spheroid central surface density, $\mu_{\rm 0, sph}$, 
and the spheroid deprojected central stellar density, $\rho_{\rm *,0,sph}$. \\
