...
\shorttitle{Lentiptical galaxies}
...
\title{Lentiptical galaxies and their ordinary black holes}
...
such as the claim that a number of lentiptical galaxies are extreme outliers 
in the $M_{\rm BH} - M_{\rm *,sph}$ diagram, 
i.e. these galaxies host a central black hole whose mass, $M_{\rm BH}$, is abnormally large 
compared to expectations from their (underestimated) bulge stellar mass, $M_{\rm *,sph}$. 
