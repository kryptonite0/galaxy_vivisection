...
with the mass of the central supermassive black hole $M_{\rm BH}$ by some studies. 
The $M_{\rm BH} - n_{\rm sph}$ correlation is also expected from other two well known galaxy scaling relations: 
the $L_{\rm sph} - n_{\rm sph}$ and the $M_{\rm BH} - L_{\rm sph}$ relations, 
...
and -- not surprisingly -- other studies have failed to recover a statistically significant $M_{\rm BH} - n_{\rm sph}$ correlation. 
With the aim of re-investigating the $M_{\rm BH} - n_{\rm sph}$ 
and other correlations between the black hole mass and various galaxy properties, 
...
This sample is the largest to date used to investigate black hole mass scaling relations. 
