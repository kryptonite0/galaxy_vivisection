...
As in \emph{Paper II}, here we will refer to early-type galaxies (E+S0) and late-type galaxies (Sp). 
The early-type bin includes two galaxies classified as E/S0, 
...
and $M_{\rm BH} - n_{\rm sph}$ diagrams (see Table \ref{tab:lregLn} and Table \ref{tab:lregMn}, respectively) 
...
allow one to predict values of the ordinate observable ($Y$) with the best possible precision. 

%for different morphological types (elliptical/lenticular/spiral)
