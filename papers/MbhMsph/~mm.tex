...
They also claimed that the black hole mass correlates equally well with the total galaxy luminosity (bulge+disk) 
as it does with the bulge luminosity. \\
The $M_{\rm BH} - L_{\rm sph}$ relation can be predicted from other two popular correlations involving the bulge velocity dispersion, $\sigma$.
While the $M_{\rm BH} - \sigma$ relation \citep{ferraresemerritt20}

the $M_{\rm BH} - \sigma$ (black hole mass - velocity dispersion) 
and 
