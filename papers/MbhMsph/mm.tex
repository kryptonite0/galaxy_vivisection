...
\begin{abstract}
{\bf limit of 250 words, currently there are 229 words, there's room for 21 words. 
Things not mentioned: 1) the galaxy components (more appropriate for data paper?????), 
2) $3.6\rm~\mu m$ \emph{Spitzer} satellite imagery, minimally affected by dust and star formation 
3) updated linear regressions (symmetrical, to be compared with theoretical expectations, and non-symmetrical, to be used to predict black hole masses) 
...
and were derived from our state-of-the-art {\bf ``many-component''} galaxy decompositions 
...
Among the bulges with $n_{\rm sph}<2$, 12 have positive vertical offset and 11 have negative vertical offset.
...
We note that AGNs with $10^5 \lesssim M_{\rm BH}/{\rm M_\odot} \lesssim 2 \times 10^6$ appear to roughly follow the blue line 
