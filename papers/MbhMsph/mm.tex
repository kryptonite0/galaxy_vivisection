...
\begin{abstract}
We present the latest correlations of black hole mass, $M_{\rm BH}$, 
with spheroid luminosity, $L_{\rm sph}$, spheroid stellar mass, $M_{\rm *,sph}$, and galaxy luminosity, $L_{\rm gal}$,
...
and were derived from our state-of-the-art multicomponent galaxy decompositions 
that, for the first time, were checked to be consistent with the galaxy kinematics. 
...
indicating that gas-rich processes feed the black hole from two to three times more efficiently than the host bulge. 
Disproving some previous claims, we also conclude that: i) S\'ersic and core-S\'ersic galaxies do not define two distinct sequences; 
...
iii) $L_{\rm sph}$ and $L_{\rm gal}$ correlate equally well with $M_{\rm BH}$, in terms of intrinsic scatter, only for early-type galaxies.
...
\caption{Black hole mass versus $3.6\rm~\mu m$ spheroid absolute magnitude. 
...
All (66)               & BCES $(Y|X)$   & $8.16 \pm 0.07$ & $-0.44 \pm 0.04$ & $-23.86$ & $-$ & $0.56$ \\
                       ...
                       & mFITEXY $(Y|X)$ & $8.17^{+0.07}_{-0.06}$ & $-0.43^{+0.03}_{-0.03}$ & $-23.86$ & $0.49^{+0.06}_{-0.05}$ & $0.56$ \\
                       & mFITEXY $(X|Y)$ & $8.15^{+0.07}_{-0.08}$ & $-0.61^{+0.05}_{-0.05}$ & $-23.86$ & $0.58^{+0.07}_{-0.06}$ & $0.67$ \\
...
$n>2$ (43)             & BCES $(Y|X)$   & $8.58 \pm 0.07$ & $-0.42 \pm 0.06$ & $-24.77$ & $-$ & $0.46$ \\
                       ...
                       & {\tt linmix\_err} Bisector    & $8.55 \pm 0.08$ & $-0.5 \pm 0.1$ & $-24.77$ & $-$    & $0.49$ \\  [0.5em]
                   
Core-S\'ersic (22) & BCES $(Y|X)$   & $9.06 \pm 0.09$ & $-0.3  \pm 0.1$  & $-25.73$ & $-$    & $0.42$ \\
                   & BCES $(X|Y)$   & $9.1  \pm 0.1$  & $-0.6  \pm 0.1$  & $-25.73$ & $-$    & $0.61$ \\
                   & BCES Bisector     & $9.1  \pm 0.1$  & $-0.47 \pm 0.08$ & $-25.73$ & $-$    & $0.48$ \\
                   & mFITEXY $(Y|X)$ & $9.06^{+0.09}_{-0.08}$ & $-0.26^{+0.07}_{-0.08}$ & $-25.73$ & $0.37^{+0.08}_{-0.06}$ & $0.42$ \\
                   & mFITEXY $(X|Y)$ & $9.0^{+0.1}_{-0.1}$ & $-0.7^{+0.2}_{-0.3}$ & $-25.73$ & $0.61^{+0.14}_{-0.09}$ & $0.67$ \\
                   & mFITEXY Bisector   & $9.0^{+0.1}_{-0.1}$ & $-0.5^{+0.1}_{-0.2}$ & $-25.73$ & $-$    & $0.48$ \\
                   & {\tt linmix\_err} $(Y|X)$  & $9.0 \pm 0.1$ & $-0.24 \pm 0.09$ & $-25.73$ & $0.40 \pm 0.08$ & $0.42$ \\
                   & {\tt linmix\_err} $(X|Y)$  & $9.0 \pm 0.2$ & $-0.7 \pm 0.3$ & $-25.73$ & $0.68 \pm 0.30$ & $0.64$ \\
                   & {\tt linmix\_err} Bisector    & $9.0 \pm 0.1$ & $-0.4 \pm 0.1$ & $-25.73$ & $-$    & $0.46$ \\ [0.5em]

S\'ersic (44) & BCES $(Y|X)$   & $7.71 \pm 0.09$ & $-0.41 \pm 0.08$ & $-22.92$ & $-$    & $0.61$ \\
              & BCES $(X|Y)$   & $7.7  \pm 0.1$  & $-0.9  \pm 0.2 $ & $-22.92$ & $-$    & $0.93$ \\
              & BCES Bisector     & $7.7  \pm 0.1$  & $-0.61 \pm 0.08$ & $-22.92$ & $-$    & $0.71$ \\
              & mFITEXY $(Y|X)$ & $7.72^{+0.08}_{-0.08}$ & ${-0.41}^{+0.07}_{-0.07}$ & $-22.92$ & $0.54^{+0.09}_{-0.07}$ & $0.61$ \\
              & mFITEXY $(X|Y)$ & $7.7^{+0.1}_{-0.1}$ & $-0.9^{+0.1}_{-0.2}$ & $-22.92$ & $0.77^{+0.13}_{-0.10}$ & $0.93$ \\
              ...
              & {\tt linmix\_err} $(X|Y)$  & $7.7 \pm  0.1$ & $-0.9 \pm 0.2$ & $-22.92$ & $0.79 \pm  0.20$ & $0.93$ \\
              & {\tt linmix\_err} Bisector    & $7.7 \pm 0.1$ & $-0.6 \pm 0.1$ & $-22.92$ & $-$    & $0.71$ \\ [0.5em]
...
{\bf Late-type (Sp)} (17) & BCES $(Y|X)$    & $7.2 \pm 0.2$ & $-0.8 \pm 0.4$ & $-22.33$ & $-$    & $0.70$ \\
                          & BCES $(X|Y)$    & $7.2 \pm 0.3$ & $-1.7 \pm 0.7$ & $-22.33$ & $-$    & $1.26$ \\
                          & {\bf BCES Bisector}& $\boldsymbol{7.2 \pm 0.2}$ & $\boldsymbol{-1.1 \pm 0.3}$ & $\boldsymbol{-22.33}$ & $-$    & $\boldsymbol{0.88}$ \\
                          & mFITEXY $(Y|X)$ & $7.2^{+0.1}_{-0.1}$ & $-0.5^{+0.2}_{-0.2}$ & $-22.33$ & $0.55^{+0.15}_{-0.10}$ & $0.62$ \\
                          & mFITEXY $(X|Y)$ & $7.4^{+0.5}_{-0.3}$ & $-2.0^{+0.7}_{-2.4}$ & $-22.33$ & $1.08^{+0.40}_{-0.24}$ & $1.50$ \\
                          & mFITEXY Bisector   & $7.3^{+0.4}_{-0.3}$ & $-1.0^{+0.3}_{-0.5}$ & $-22.33$ & $-$    & $0.82$ \\
                          & {\tt linmix\_err} $(Y|X)$  & $7.2 \pm 0.2$ & $-0.5 \pm 0.3$ & $-22.33$ & $0.64 \pm 0.16$ & $0.62$ \\
                          & {\tt linmix\_err} $(X|Y)$  & $7.3 \pm 0.4$ & $-1.9 \pm 1.2$ & $-22.33$ & $1.3 \pm 0.9$ & $1.4$ \\
                          & {\tt linmix\_err} Bisector    & $7.3 \pm 0.3$ & $-0.9 \pm 0.5$ & $-22.33$ & $-$    & $0.78$ \\
...
\\
 ...
 All (62)		& BCES $(Y|X)$   & $8.26 \pm 0.08$ & $-0.49 \pm 0.06$ & $-24.78$ & $-$ & $0.64$ \\
 			& BCES $(X|Y)$   & $8.3 \pm 0.1$   & $-1.0 \pm 0.1$   & $-24.78$ & $-$ & $0.92$ \\
 			& BCES Bisector     & $8.26 \pm 0.09$ & $-0.72 \pm 0.07$ & $-24.78$ & $-$ & $0.71$ \\
 			& mFITEXY $(Y|X)$ & $8.26^{+0.08}_{-0.08}$ & $-0.49^{+0.06}_{-0.07}$ & $-24.78$ & $0.61^{+0.07}_{-0.05}$ & $0.64$ \\
 			& mFITEXY $(X|Y)$ & $8.3^{+0.1}_{-0.1}$    & $-1.0^{+0.1}_{-0.2}$	& $-24.78$ & $0.88^{+0.10}_{-0.08}$ & $0.93$ \\
 			& mFITEXY Bisector   & $8.3^{+0.1}_{-0.1}$    & $-0.72^{+0.09}_{-0.10}$ & $-24.78$ & $-$    & $0.71$ \\
 			& {\tt linmix\_err} $(Y|X)$  & $8.26 \pm 0.08$ & $-0.49 \pm 0.07$ & $-24.78$ & $0.63 \pm 0.07$ & $0.64$ \\
 			& {\tt linmix\_err} $(X|Y)$  & $8.3 \pm 0.1$ & $-1.0 \pm 0.1$ & $-24.78$ & $0.91 \pm 0.17$ & $0.93$ \\
 			& {\tt linmix\_err} Bisector    & $8.3 \pm 0.1$ & $-0.7 \pm 0.1$ & $-24.78$ & $-$    & $0.71$ \\ [0.5em]

 Early-type (E+S0) (45) & BCES $(Y|X)$   & $8.56 \pm 0.06$ & $-0.43 \pm 0.05$ & $-24.88$ & $-$ & $0.45$ \\
 			& BCES $(X|Y)$   & $8.56 \pm 0.08$ & $-0.63 \pm 0.05$ & $-24.88$ & $-$ & $0.53$ \\
 			...
 			& mFITEXY $(X|Y)$ & $8.56^{+0.08}_{-0.08}$ & $-0.66^{+0.06}_{-0.08}$ & $-24.88$ & $0.51^{+0.07}_{-0.06}$ & $0.55$ \\
 			...
 			& {\tt linmix\_err} Bisector    & $8.56 \pm 0.08$ & $-0.5 \pm 0.1$ & $-24.88$ & $-$    & $0.47$ \\
...
{\bf Early-type (E+S0)} (45)  & BCES $(Y|X)$    & $8.56 \pm 0.07$ & $0.8 \pm 0.1$ & $10.81$ & $-$ & $0.48$ \\
                              & BCES $(X|Y)$    & $8.56 \pm 0.08$ & $1.3 \pm 0.1$ & $10.81$ & $-$ & $0.59$ \\
                              & {\bf BCES Bisector}& $\boldsymbol{8.56 \pm 0.07}$ & $\boldsymbol{1.0 \pm 0.1}$ & $\boldsymbol{10.81}$ & $-$ & $\boldsymbol{0.51}$ \\
                              & mFITEXY $(Y|X)$  & $8.56^{+0.06}_{-0.07}$ & $0.8^{+0.1}_{-0.1}$ & $10.81$ & $0.42^{+0.06}_{-0.05}$ & $0.48$ \\
                              & mFITEXY $(X|Y)$  & $8.54^{+0.09}_{-0.08}$ & $1.3^{+0.2}_{-0.1}$ & $10.81$ & $0.53^{+0.08}_{-0.07}$ & $0.61$ \\
                              & mFITEXY Bisector    & $8.55^{+0.07}_{-0.08}$ & $1.0^{+0.1}_{-0.1}$ & $10.81$ & $-$                    & $0.51$ \\
                              & {\tt linmix\_err} $(Y|X)$  & $8.55 \pm 0.07$ & $0.8 \pm 0.1$ & $10.81$ & $0.43 \pm 0.06$ & $0.48$ \\
                              & {\tt linmix\_err} $(X|Y)$  & $8.55 \pm 0.09$ & $1.3 \pm 0.2$ & $10.81$ & $0.54 \pm 0.11$ & $0.59$ \\
                              & {\tt linmix\_err} Bisector    & $8.55 \pm 0.08$ & $1.0 \pm 0.2$ & $10.81$ & $-$    & $0.51$ \\ [0.5em]

{\bf Late-type (Sp)} (17)    & BCES $(Y|X)$    & $7.2 \pm 0.2$ & $1.9 \pm 1.5$ & $10.05$ & $-$ & $0.74$ \\ 
                             & BCES $(X|Y)$    & $7.2 \pm 0.4$ & $5.9 \pm 3.4$ & $10.05$ & $-$ & $1.70$ \\
                             & {\bf BCES Bisector}& $\boldsymbol{7.2 \pm 0.2}$ & $\boldsymbol{3.0 \pm 1.3}$ & $\boldsymbol{10.05}$ & $-$ & $\boldsymbol{0.94}$ \\
                             & mFITEXY $(Y|X)$  & $7.2^{+0.1}_{-0.2}$ & $1.2^{+0.7}_{-0.6}$ & $10.05$ & $0.59^{+0.16}_{-0.11}$ & $0.66$ \\
                             & mFITEXY $(X|Y)$  & $7.4^{+1.5}_{-0.5}$ & $7.1^{+26.3}_{-3.0}$ & $10.05$ & $1.49^{+0.57}_{-0.35}$ & $2.08$ \\
                             & mFITEXY Bisector    & $7.2^{+1.0}_{-0.4}$ & $2.3^{+1.7}_{-1.0}$ & $10.05$ & $-$    & $0.79$ \\
                             & {\tt linmix\_err} $(Y|X)$  & $7.2 \pm 0.2$ & $0.9 \pm 0.9$ & $10.05$ & $0.67 \pm 0.16$ & $0.65$ \\
                             & \textcolor{red}{{\tt linmix\_err} $(X|Y)$}  & $7.4 \pm 0.6$ & $7.0 \pm 6.6$ & $10.05$ & $1.83 \pm 1.82$ & $2.04$ \\
                             & \textcolor{red}{{\tt linmix\_err} Bisector}    & $7.3 \pm 0.5$ & $1.9 \pm 203.0$ & $10.05$ & $-$    & $0.74$ \\
...
Because the value of the intrinsic scatter depends on the uncertainties associated to the luminosities\footnote{The 
...
On the other hand, the uncertainties associated to $L_{\rm sph}$ have been estimated 
with an advanced method that takes into account the systematic errors related to the galaxy decomposition process. 
We consider these uncertainties trustworthy and, therefore, we decided to vary only the errors associated to $L_{\rm gal}$.
...
Because such error is larger than the typical error on $L_{\rm sph}$ used here
-- and, in general, is significantly larger than the uncertainties on $L_{\rm gal}$ that are typically used in the literature --, 
we come to the conclusion that our determination of the intrinsic scatter is reliable, 
and that, for early-type galaxies, $M_{\rm BH}$ correlates equally well with $L_{\rm sph}$ and $L_{\rm gal}$.
...
The bulges of early-type galaxies follow $M_{\rm BH} \propto M_{\rm *,sph}^{1.0 \pm 0.1}$,
as expected from a dry-merging formation scenario,
and define a tight \emph{red sequence} with intrinsic scatter $\epsilon_{(Y|X)} = 0.43 \pm 0.06\rm~dex$. 
On the other hand, the bulges of spiral galaxies trace a steeper \emph{blue sequence}, 
whose slope is not well constrained due to the small size of the subsample and, more importantly, 
to the small range in $M_{\rm *,sph}$ that the subsample spans.
For the bulges of spiral galaxies, the BCES code returns a bisector linear regression $M_{\rm BH} \propto M_{\rm *,sph}^{3.0 \pm 1.3}$, 
while the modified FITEXY routine finds a shallower (but still consistent within the $1\sigma$ uncertainty) slope of $2.3^{+1.7}_{-1.0}$.
...
{\bf which code do we trust more in this case? BCES or FITEXY? is it a quadratic or a cubic growth? } 

\cite{grahamscott2015} collected a sample of $\sim$170 low-redshift ($z \lesssim 0.1$) bulges hosting Active Galactic Nuclei (AGNs) with 
black hole masses $10^5 \lesssim M_{\rm BH}/{\rm M_\odot} \lesssim 0.5 \times 10^8$, 
and showed that they roughly follow the quadratic $M_{\rm BH} - M_{\rm *,sph}$ relation defined by predominantly inactive S\'ersic bulges. 
...
tracks the location of the AGNs in the $M_{\rm BH} - M_{\rm *,sph}$ diagram, 
i.e. the AGNs appears to be the low-mass continuation of the \emph{blue sequence} shown in Figure \ref{fig:mbhmasssph}. 
We also note that the majority of our spiral galaxies hosts an AGN\footnote{According to the nuclear classification reported on NED 
(Nasa Extragalactic Database), among our 17 spiral galaxies, at least 12 host a Seyfert AGN and one hosts a LINER AGN.}.\\
{\bf cite Anne's paper}\\
{\bf AL: however we analyze the agns in another paper, blah blah}
