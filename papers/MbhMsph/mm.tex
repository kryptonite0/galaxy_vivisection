...
\begin{abstract}
We present correlations between black hole mass, $M_{\rm BH}$, 
and both the host galaxy's and spheroid's infrared luminosity, $L_{\rm gal}$ and $L_{\rm sph}$, 
and the spheroid's stellar mass, $M_{\rm *,sph}$,
built upon a high-quality data set.
...
{\bf limit of 250 words, no room for mentioning the gaalxy components, more appropriate for data paper}
Previous studies have used galaxy samples that were overwhelmingly dominated by high-mass, early-type objects.
...
We conclude that: i) S\'ersic galaxies follow $M_{\rm BH} \propto M_{\rm *,sph}^{x \pm x}$, a less steep sequence than previously reported; 
...
\\
 ...
 Late-type (Sp) (17) & BCES $(Y|X)$      & $7.37 \pm 0.17$ & $-0.33 \pm 0.87$   & $-24.39$ & $-$ & $0.65$ \\
...
{\bf Late-type (Sp)} (17)    & BCES $(Y|X)$    & $7.18 \pm 0.17$ & $1.95 \pm 1.52$ & $10.05$ & $-$ & $0.74$ \\ 
                             ...
                             & mFITEXY Bisector    & $7.24^{+1.04}_{-0.39}$ & $2.28^{+1.67}_{-1.01}$  & $10.05$ & $-$    & $0.79$ \\
