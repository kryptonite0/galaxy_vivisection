...
\begin{abstract}
We have the best latest M-L and M-M diagrams (66 galaxies = biggest sample ever used, IR imaging = 
minimally affected by dust and star formation, 
state-of-the-art multicomponent galaxy decompositions = 
we fit bulges, disks, spiral arms, bars, rings, haloes, extended or unresolved nuclear sources and partially depleted cores).
Previous samples were overwhelmingly dominated by early-type galaxies, our sample includes 17 spiral galaxies, 
half of which have $M_{\rm BH} < 10^7 M_\odot$,
thus we can explore the low-mass end of the diagrams.
We provide a table with spheroid luminosities, spheroid stellar masses and galaxy luminosities. 
We give updated linear regressions for Sersic/core-Sersic galaxies and for different morphological types (E/S0, Sp). 
Sersic and core-Sersic galaxies have slopes consistent with each other (contrary to what claimed by GS13). 
In the M-M diagram, bulges of early type galaxies have a slope of $\sim$1, while bulges of spiral galaxies have a slope of 2-3.
Linear regressions that we provide are symmetrical (to be compared with theoretical expectations) 
and non-symmetrical (to be used to predict BH masses).
Contrary to a previous claim, 
the bulge luminosity appears to be a better indicator of the BH mass than the galaxy luminosity.
only for early type galaxies one can use the tot luminosity as bh mass indicator {\bf check and expand}
Bulges with $n<2$, claimed by some to be pseudobulges, are not offset to lower BH masses from the correlation defined by bulges with $n>2$.
...
\hline 
\\
{\bf Spheroids} & \multicolumn{6}{l}{$\log[M_{\rm BH}/{\rm M_\odot}] = \alpha + \beta[(MAG_{\rm sph} - X_0)/{\rm mag}]$} \\ [0.5em]
...
\hline 
\\
{\bf Total galaxies} & \multicolumn{6}{l}{$\log[M_{\rm BH}/{\rm M_\odot}] = \alpha + \beta[(MAG_{\rm gal} - X_0)/{\rm mag}]$} \\ [0.5em]
...
\label{sec:res}
We performed a linear regression analysis of the $M_{\rm BH} - L_{\rm sph}$ and $M_{\rm BH} - L_{\rm gal}$ diagrams 
...
In Table \ref{tab:lreg} we report the BCES and modified FITEXY linear regressions for S\'ersic/core-S\'ersic 
galaxies and for different morphological types (elliptical/lenticular, spiral).
...
in disagreement with the findings of \cite{grahamscott2013}. 
core galaxies have same slope
sersic gal have shallower slope
magnitudes of bulges are brighter for the high luminosity sersic galaxies (embedded disks confused with large scale ones)
and fainter for the low luminosity ones (more components in galaxies)


ELL and S0s separately have both slopes consistent with 1. 
they define a single sequence.
vertical scatter along the early type sequence is constant?
if 2 overmassive bhs removed, what happens?
In the M-M diagram, bulges of early type galaxies have a slope of $\sim$1, while bulges of spiral galaxies have a slope of 2-3.
Linear regressions that we provide are symmetrical (to be compared with theoretical expectations) and non-symmetrical (to be used to predict BH masses).
