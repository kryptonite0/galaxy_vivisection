...
At the low-mass end, the bulges of late-type (Sp) galaxies define a much steeper 
\emph{blue sequence}, 
...
{\bf 
As a final remark, we comment on the work done by \cite{reinesvolonteri2015}, 
...
\item {\bf It has been argued that pseuso-bulges (disk-like, rotation-supported systems, built from secular processes) 
      ...
      Although we do not consider the S\'ersic index a good indicator as of the nature of a bulge (e.g.~\citealt{grahamworley2008}), 
      we investigated this point and found that, within the current dataset,  
      spheroids with $n_{\rm sph}<2$, argued by some to be pseudo-bulges, 
