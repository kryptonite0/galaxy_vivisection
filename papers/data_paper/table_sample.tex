...
NGC 7619  &  $51.5$  &  $25_{-3}^{+8}$   &  R+13b  &  yes$^a$  $(0.5)$  &  DG13, R+13a  &      &     &  yes  &  no  \\ 
...
$^a$ NGC 7619 may contain an embedded disk, rather than possessing a partially depleted core (see Figure \ref{fig:n7619}).
} 
\end{center}    
\end{table*}    
