...
\clearpage
  ...
  \end{center}
  \label{tab:n3377}
  \tablecomments{L+14 2D obtained the smallest estimate of the effective radius because they oversubtracted a halo.   
  }
  \end{table}
  ...
  \label{tab:n3414}
  \tablecomments{
  L+10 2D used a model with a large-scale exponential disk, thus they obtained a smaller bulge effective radius and S\'ersic index.
  }
  \end{table}
  ...
  \label{tab:n3489}
  %\tablecomments{
  %S+11 2D did not fit the bar and thus obtained a larger estimate of the bulge effective radius.
  %}
  \end{table}
  ...
  \end{center}
  \label{tab:n3607}
  \tablecomments{L+10 2D obtained the smallest estimates of the effective radius and S\'ersic index because
  they oversubtracted a large-scale disk.
  }
  \end{table}
  ...
  \end{center}
  \label{tab:n3608}
  \tablecomments{B+12 2D obtained the largest estimates of the effective radius and S\'ersic index, 
  ...
  \end{center}
  \label{tab:n4026}
  \tablecomments{S+11 2D obtained larger estimates of the bulge effective radius and S\'ersic index because they did not model the bar.}
  \end{table}
  ...
  \label{tab:n4261}
  \tablecomments{
  S+11 2D found the smallest estimate of the effective radius because they added a large-scale disk to their model.
  V+12 2D obtained a small estimate of the effective radius because of the limited radial extent of their data.
  }
  \end{table}
  ...
  \label{tab:n4459}
  \tablecomments{
  B+12 2D did not model the large-scale disk and thus overestimated the bulge effective radius and S\'ersic index.
  }
  \end{table}
  ...
  \label{tab:n4459}
  \tablecomments{
  B+12 2D obtained the smallest estimates of the effective radius and S\'ersic index because they oversubtracted a large-scale disk. 
  }
  \end{table}
  ...
  \end{center}
  \label{tab:n4564}
  \tablecomments{The most dicrepant results are obtained by S+11 2D, although they used the same model as GD07 1D maj. and V+12 2D. }
  \end{table}
  ...
  \label{tab:n4596}
  \tablecomments{
  B+12 2D fit nor the bar neither the inner disk and obtained the largest estimates of the bulge effective radius and S\'ersic index.
  The models of S+11 2D and V+12 2D do not account for the inner disk and thus result in larger estimates of the bulge effective radius.
  }
  \end{table}
  ...
  \label{tab:n4697}
  \tablecomments{
  In both their models, V+12 2D underestimated the effective radius and the S\'ersic index because of the small radial range of their data. 
  L+14 2D oversubtracted a large-scale disk and a halo, and thus underestimated the spheroid effective radius and the S\'ersic index. 
  }
  \end{table}
  ...
  \end{center}
  \label{tab:n5845}
  \tablecomments{The results obtained by S+11 2D and B+12 2D best agree with the results from our 2D model, 
  in which we did not mask the inner region of the galaxy. 
  The small radial extent of the data used by V+12 2D led them to underestimate the effective radius.}
  \end{table}
  ...
  \end{center}
  \label{tab:n5846}
  \tablecomments{S+11 2D did not mask the core and thus underestimated the effective radius and S\'ersic index. }
  \end{table}
  ...
  \end{center}
  \label{tab:n6251}
  \tablecomments{It is not clear why GD07 1D maj. obtained the largest estimates of the effective radius and S\'ersic index.}
  \end{table}
  ...
  \end{center}
  \label{tab:n7052}
  \tablecomments{The model of V+12 2D oversubtracts a large-scale disk and thus results in the lowest estimates of the effective radius and S\'ersic index.}
  \end{table}
