...
def spiral(ax, color, x0, y0, size_x, size_y):
	...
	ax.plot(10**(x0+x1),(y0+y1), color=color, lw=2, **scatter_kwargs2)
	ax.plot(10**(x0+x2),(y0+y2), color=color, lw=2, **scatter_kwargs2)
	ax.plot(10**(x0+x),(y0+y), color=color, lw=2, **scatter_kwargs2)
...
def lenticular(ax, color, x0, y0, size_x, size_y):
	...
	ax.plot([10**(x0-2*size_x),10**(x0+2*size_x)],[(y0),(y0)], color=color, lw=3, **scatter_kwargs)
