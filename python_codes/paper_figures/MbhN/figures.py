...
def mbh_vs_n_sph_eq():
	...
	ax.scatter(n[simplemorphtype=='merger'], mbh[simplemorphtype=='merger'], marker=r'$\star$', s=500, color='k', **scatter_kwargs)	
       ...
       #
        # legend
        markers_n.elliptical(ax, 'red', np.log10(0.5), np.log10(10**10.3), 0.032, 0.06)
        ax.text(0.5, 10**10.3, 'E')
       #markers.lenticular(ax, 'red', 8.85, 10.45, 0.08)
       #ax.text(10**9.1, 10**10.3, 'E/S0')
       #markers.lenticular(ax, 'darkorange', 8.85, 10., 0.08)
       #ax.text(10**9.1, 10**9.85, 'S0')
	...
	ins.set_yscale('log')
        ...
        ins.errorbar(n[simplemorphtype=='S0'], mbh[simplemorphtype=='S0'],
        	...
        	ecolor='orange', marker='', ls=' ', elinewidth=1.2, capthick=1.2, barsabove=False)
